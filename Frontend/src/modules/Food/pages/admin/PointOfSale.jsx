        ...
        <div className="bg-white rounded-lg shadow-sm border border-[#e3e6ef] p-6 mb-6">
          <div className="flex flex-col gap-4">
                ...
                <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5 z-10" />
                  ...
                  className="w-full h-11 pl-10 pr-3 rounded-md border border-[#e3e6ef] bg-white text-sm text-[#4a5671] focus:outline-none focus:ring-1 focus:ring-[#DC2626]"
                />
                  ...
                  onChange={(e) => {
                    ...
                    if (selected) {
                      setSearchQuery(selected.name)
                        ...
                        className="w-full h-11 rounded-md border border-[#e3e6ef] bg-white px-3 pr-10 text-sm text-[#4a5671] focus:outline-none focus:ring-1 focus:ring-[#DC2626]"
                      >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center py-3 border-b border-[#e3e6ef]">
                    ...
                    <span className="text-base font-semibold text-[#DC2626]">{formatCurrency(analyticsData.totalCommission)}</span>
                  </div>
                  <div className="flex justify-between items-center py-3 border-b border-[#e3e6ef]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between items-center py-2">
                    ...
                    <span className="text-sm font-bold text-[#DC2626]">{formatCurrency(paymentSummary?.total || 0)}</span>
                  </div>
                </div>
