      ...
      <div className="flex-1 px-4">
        ...
        <div className="mb-3">
          ...
          <div className="flex items-center justify-between mt-1">
            <span className="text-xs text-restaurant-primary">Very Bad</span>
        ...
        <motion.button
          ...
          className={`w-full py-3 rounded-full text-sm font-medium transition-colors ${
            rating === null
              ...
              : "bg-gradient-to-br from-restaurant-primary to-restaurant-secondary text-white hover:bg-gradient-to-br from-restaurant-primary to-restaurant-secondary"
          }`}
          ...
          >
            ...
            >
              <div className="flex flex-col items-center text-center">
                ...
                <button
                  type="button"
                  className="w-full py-2.5 rounded-full bg-gradient-to-br from-restaurant-primary to-restaurant-secondary text-white text-sm font-medium"
                  onClick={() => {
                    setShowThanks(false)
                    goBack()
                  }}
