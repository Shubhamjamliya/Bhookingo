              ...
              {!isOtpStep ? (
                ...
                >
                  ...
                  <button
                    ...
                    className="w-full py-3.5 bg-gradient-to-r from-restaurant-primary to-restaurant-secondary hover:from-[#A10935] hover:to-[#4F0016] disabled:opacity-50 text-white rounded-full font-medium text-base shadow-[0_8px_20px_rgba(184,11,61,0.3)] disabled:shadow-none transition-all active:scale-[0.98] flex items-center justify-center gap-2"
                  >
                    {loading ? (
