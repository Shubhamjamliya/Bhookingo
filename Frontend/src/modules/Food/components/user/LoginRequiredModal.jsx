...
const WarliBorder = () => (
  <svg width="100%" height="45" viewBox="0 0 350 45" preserveAspectRatio="none" className="opacity-[0.12] dark:opacity-20 text-[var(--primary)]">
  ...
  return (
    <div className="fixed inset-0 z-[999999] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-[380px] bg-[#FCF9F2] dark:bg-[#1C1613] rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.3)] border border-[#EBE1CD] dark:border-[#382D24] overflow-hidden transform transition-all duration-300 scale-100 flex flex-col items-center p-6 text-center animate-in fade-in zoom-in-95 duration-200">
        ...
        <button 
          onClick={onClose}
          className="absolute top-4 right-4 p-1.5 rounded-full hover:bg-[#EBE1CD]/40 dark:hover:bg-[#382D24]/40 text-[var(--primary)] dark:text-[#EAE0D5] transition-colors"
        ...
        <div className="w-full absolute top-0 left-0 right-0 pointer-events-none select-none">
          <div className="h-[2px] w-full bg-[var(--primary)] opacity-30" />
        </div>
        ...
        <div className="mt-6 mb-5 flex items-center justify-center w-16 h-16 rounded-2xl bg-[#EBE1CD]/30 dark:bg-[#382D24]/30 border border-[#EBE1CD] dark:border-[#382D24] shadow-sm">
          <LogOut className="w-7 h-7 text-[var(--primary)] dark:text-[#E8AF9D]" />
        </div>

        {/* Heading */}
        <h3 className="text-xl font-black tracking-wider text-[var(--primary)] dark:text-[#F3D7C9] uppercase mb-3 font-serif">
          LOGIN REQUIRED
        </h3>
        ...
        <button
          ...
          className="w-full py-3.5 px-6 rounded-full bg-[var(--primary)] hover:bg-[#B91C1C] active:bg-[var(--primary-dark)] text-white font-bold tracking-widest text-sm shadow-md hover:shadow-lg transition-all transform active:scale-98 mb-6"
        >
          LOGIN / SIGN UP
        </button>
