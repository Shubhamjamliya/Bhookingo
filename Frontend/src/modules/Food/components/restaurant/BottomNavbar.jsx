      ...
      <div className="flex items-center justify-around py-2 px-4">
        <button
          ...
          className={`flex flex-col items-center gap-1 p-2 transition-colors ${
            isActive("/food/restaurant") ? "text-restaurant-primary" : "text-gray-600"
          }`}
        >
        ...
        <button
          ...
          className={`flex flex-col items-center gap-1 p-2 transition-colors ${
            isActive("/food/restaurant/orders") ? "text-restaurant-primary" : "text-gray-600"
          }`}
        >
        ...
        <button
          ...
          className={`flex flex-col items-center gap-1 p-2 -mt-8 transition-colors ${
            isActive("/food/restaurant/explore") ? "text-restaurant-primary" : "text-gray-600"
          }`}
        >
          <div
            className={`rounded-full p-3 shadow-lg border-2 transition-colors ${
              isActive("/food/restaurant/explore")
                ? "bg-gradient-to-br from-restaurant-primary to-restaurant-secondary border-white"
        ...
        <button
          ...
          className={`flex flex-col items-center gap-1 p-2 transition-colors ${
            isActive("/food/restaurant/wallet") ? "text-restaurant-primary" : "text-gray-600"
          }`}
        >
        ...
        <button
          ...
          className={`flex flex-col items-center gap-1 p-2 transition-colors ${
            isActive("/food/restaurant/food/all") ? "text-restaurant-primary" : "text-gray-600"
          }`}
        >
