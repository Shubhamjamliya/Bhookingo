        ...
        <AnimatedPage className="min-h-screen bg-background pb-20">
            ...
            <div className="sticky top-0 z-50 bg-white/80 backdrop-blur-xl border-b border-border">
                <div className="max-w-lg mx-auto px-4 h-16 flex items-center gap-4">
                    ...
                    <h1 className="text-xl font-black text-text-primary tracking-tight uppercase">Modification</h1>
                </div>
            </div>
            ...
            <div className="max-w-lg mx-auto px-4 py-8 space-y-6">
                ...
                <div className="bg-surface rounded-[2.5rem] p-8 shadow-sm border border-border text-center space-y-4">
                    <div className="w-20 h-20 bg-[var(--primary)]/10 text-[var(--primary)] rounded-full flex items-center justify-center mx-auto mb-2 animate-pulse">
                        <Clock className="w-10 h-10" />
                    </div>
                    <div>
                        <h2 className="text-2xl font-black text-text-primary tracking-tight leading-tight">Can I make changes?</h2>
                        <p className="text-sm text-text-secondary font-bold uppercase tracking-widest mt-2 px-4">Flexible modifications for your comfort</p>
                    </div>
                </div>

                {/* Info Box */}
                <div className="bg-[var(--primary)] rounded-3xl p-6 text-white shadow-xl shadow-[var(--primary)]/20">
                ...
                <div className="space-y-4 pt-4">
                    <p className="text-[10px] font-black text-text-secondary uppercase tracking-[0.3em] ml-2">What you can change</p>
                ...
                <div className="pt-6 space-y-4">
                    <button 
                        ...
                        className="w-full h-14 bg-[var(--primary)] text-white rounded-2xl font-black uppercase tracking-widest text-sm shadow-xl shadow-[var(--primary)]/20 active:scale-95 transition-all"
                    >
                        Modify Details Now
                    </button>
                    <button 
                        onClick={handleBack}
                        className="w-full h-14 bg-slate-100 text-text-secondary rounded-2xl font-black uppercase tracking-widest text-sm active:scale-95 transition-all"
                    >
