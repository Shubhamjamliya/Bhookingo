        ...
        {showDownloadPopup && (
          <>
            ...
            >
              ...
              <button
                onClick={() => setShowDownloadPopup(false)}
                className="w-full py-3 bg-gradient-to-br from-restaurant-primary to-restaurant-secondary text-white rounded-lg font-medium hover:bg-gray-800 transition-colors"
              >
                Close
              </button>
            </motion.div>
