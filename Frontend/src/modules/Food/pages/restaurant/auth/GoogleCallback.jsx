      ...
      <div className="w-full max-w-md bg-white rounded-xl shadow-lg p-6 space-y-6">
        ...
        {status === "error" && (
          <div className="flex flex-col items-center justify-center py-6 space-y-4">
            <XCircle className="h-14 w-14 text-restaurant-primary" />
            {error && (
            ...
            <div className="flex gap-3 w-full pt-2">
              ...
              <Button
                onClick={handleRetry}
                className="flex-1 bg-gradient-to-br from-restaurant-primary to-restaurant-secondary hover:bg-blue-700 text-white"
              >
                Try Again
              </Button>
            </div>
