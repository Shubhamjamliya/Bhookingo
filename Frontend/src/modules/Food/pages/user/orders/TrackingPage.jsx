...
const TrackingPage = () => {
  ...
  return (
    <div className="relative min-h-screen bg-gray-900 font-sans overflow-hidden">
      ...
      <div className="absolute top-0 left-0 right-0 z-20 bg-[var(--primary)] p-4 pt-4 rounded-b-2xl shadow-lg">
        ...
        <div className="text-center text-white">
          ...
          <div className="flex items-center justify-center gap-2 bg-[var(--primary-dark)] w-fit mx-auto px-4 py-2 rounded-full">
      ...
      <div className="absolute top-0 left-0 w-full h-full z-0">
        ...
        {/* Arrival Time Card */}
        <div className="absolute bottom-[50vh] left-4 right-4 z-10 bg-surface dark:bg-[#1a1a1a] rounded-xl p-4 shadow-lg border border-border dark:border-gray-800">
          <p className="text-xs text-text-secondary dark:text-text-secondary mb-1 uppercase">ARRIVING IN</p>
          <p className="text-3xl font-bold text-primary mb-1">80 mins</p>
          <p className="text-sm text-text-secondary dark:text-text-secondary mb-2">45.1 km away</p>
          <div className="w-full h-2 bg-gray-200 dark:bg-gray-800 rounded-full overflow-hidden">
            <div className="h-full bg-[var(--primary)] rounded-full" style={{ width: '60%' }}></div>
          </div>
        </div>
      </div>
        ...
        <div className="p-5 space-y-4">
          ...
          <div className="bg-gray-800 rounded-xl p-4 border border-gray-700 shadow-sm">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-full bg-red-900/30 flex items-center justify-center">
                <UtensilsCrossed className="w-6 h-6 text-primary-light" />
              </div>
          ...
          <div className="bg-gray-800 rounded-xl p-4 border border-gray-700 shadow-sm">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-text-secondary">+91 7610416911</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-800 rounded-xl p-4 border border-gray-700 shadow-sm">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <p className="text-sm text-text-secondary">X2RJ+QHR, Dewas, Madhya Pradesh 45...</p>
              </div>
            </div>
          </div>
        </div>
