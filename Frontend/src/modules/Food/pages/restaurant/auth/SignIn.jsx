            ...
            <div className="flex items-center justify-between text-sm">
              <label className="flex items-center gap-2 cursor-pointer select-none">
                <Checkbox
                  ...
                  className="border-gray-300 data-[state=checked]:bg-gradient-to-br from-restaurant-primary to-restaurant-secondary data-[state=checked]:border-primary-orange"
                />
