    ...
    <div className="h-screen w-full flex bg-white overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative">
        ...
        <div className="absolute inset-0 flex items-center text-white pointer-events-none">
          <div className="bg-gradient-to-br from-restaurant-primary to-restaurant-secondary/80 rounded-r-full py-10 xl:py-20 pl-10 xl:pl-14 pr-10 xl:pr-20 max-w-[70%] shadow-xl backdrop-blur-[1px]">
      ...
      <div className="w-full lg:w-1/2 h-full flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-6 sm:px-10 lg:px-16 pb-8">
          <Card className="w-full max-w-lg bg-white/80 backdrop-blur-sm border border-gray-200 shadow-xl">
            <CardHeader>
              <CardTitle className="text-2xl sm:text-restaurant-primaryxl font-semibold text-gray-900">
            ...
            <CardContent className="space-y-5">
              ...
              {step === 1 && (
                <form onSubmit={handleFormSubmit} className="space-y-5">
                  ...
                  <Button
                    type="submit"
                    className="h-11 w-full bg-gradient-to-br from-restaurant-primary to-restaurant-secondary hover:bg-gradient-to-br from-restaurant-primary to-restaurant-secondary/90 text-white"
                    disabled={isLoading}
                  >
