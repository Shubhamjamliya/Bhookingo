            ...
            .map((name) => {
              ...
              return (
                ...
                >
                  ...
                  <span
                    className={`w-5 h-5 border border-restaurant-primary rounded-sm flex items-center justify-center ${
                      isSelected ? "bg-gradient-to-br from-restaurant-primary to-restaurant-secondary" : "bg-white"
                    }`}
                  >
        ...
        <button
          ...
          className={`w-full h-12 rounded-xl text-base font-bold shadow-lg transition-all active:scale-[0.98] ${
            selected.length === 0
              ...
              : "bg-gradient-to-br from-restaurant-primary to-restaurant-secondary text-white shadow-restaurant-primary/20"
          }`}
        >
          Update Cuisines
        </button>
